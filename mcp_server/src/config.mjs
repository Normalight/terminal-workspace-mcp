...
const schema = z.object({
  ...
  terminal: z.object({ shell: text, maxSessions: count(1, 1000), maxWaitMs: count(100, 120000), maxOutputBytes: count(1024, 2097152), idleTtlMs: count(0, 2147483647), gcIntervalMs: count(1000, 2147483647) }).strict(),
