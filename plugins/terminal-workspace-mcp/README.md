# Terminal Workspace MCP Plugin

Connect to a self-hosted Terminal Workspace MCP server through two tools: `execute_command` for persistent tmux execution, input, and output polling; `get_file` for original files and images. Directory operations, text editing, search, Git, and process management use ordinary shell commands.
